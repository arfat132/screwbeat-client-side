...
const Tool = ({ tool }) => {
    const { img, price, name, description, minOrderQuantity, quantity } = tool;
    return (
            ...
            <div class="h-[550px] shadow-md rounded-md border border-gray-200">
                ...
                <div class="px-5">
                    ...
                    <div class="flex justify-between items-center relative bottom-0 mt-5">
                        ...
                        <button className='bg-primary text-white px-6 py-2 uppercase font-bold rounded-lg'>Buy Now</button>
                    </div>
                </div>
            </div>
        </div>
