...
const Light = ({ light }) => {
    ...
    return (
        <div className="p-4 md:w-1/4">
            <div className="h-[570px] border border-gray-200 relative">
                ...
                <div className="px-5">
                    ...
                    <div className="flex justify-between items-center absolute bottom-4">
                        ...
                        <button onClick={() => navigateToDetails(_id)} className='bg-primary text-white px-6 py-2 uppercase font-bold rounded-lg ml-28'>Buy Now</button>
                    </div>
                </div>
            </div>
        </div>
