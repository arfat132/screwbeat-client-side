            ...
            <div className="lg:w-3/5 md:w-1/1 w-full overflow-hidden flex  items-end justify-start mt-6">
                <div class="lg:flex block">
                    <div class="flex mb-8 w-full">
                        ...
                        <div class="w-full">
                            <h4 class="font-bold text-primary text-xl mb-1">Our Location</h4>
                    ...
                    <div class="flex mb-8 w-full">
                        ...
                        <div class="w-full">
                            <h4 class="font-bold text-primary text-xl mb-1">Phone Number</h4>
                    ...
                    <div class="flex w-full">
                        <div class="
                             ...
                             rounded
                             ">
                            <svg width="28" height="19" viewBox="0 0 28 19" class="fill-current text-primary" >
                        ...
                        <div class="w-full">
                            <h4 class="font-bold text-primary text-xl mb-1">
                                Email Address
                            </h4>
