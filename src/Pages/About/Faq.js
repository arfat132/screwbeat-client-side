...
const Faq1 = () => {
    ...
    return (
        <div className=" 2xl:container 2xl:mx-auto md:py-12 lg:px-12 md:px-6 py-9 px-4">
            ...
            <div className=" flex md:flex-row flex-col md:space-x-8 md:mt-16 mt-8">
                <div className=" md:w-5/12 lg:w-4/12 w-full">
                    <img src="https://images.woodenstreet.de/image/cache/data%2Fhome-decors%2Fjainsons+Lights%2Fwhite-iron-hanging-lights-gold-finish%2Ffront-408x408.jpg" alt="Img of Glass bottle" className="w-full lg:block md:hidden hidden" />
                    <img src="https://images.woodenstreet.de/image/cache/data%2Fhome-decors%2Fjainsons+Lights%2Fwhite-iron-hanging-lights-gold-finish%2Ffront-408x408.jpg" alt="Img of Glass bottle" className="w-full lg:hidden md:block block " />
                </div>
