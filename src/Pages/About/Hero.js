        ...
        <div className="lg:mx-12">
            <div className="flex flex-col lg:flex-row items-stretch justify-between lg:px-0 px-6 lg:py-16 py-8 2xl:mx-auto 2xl:container">
                <div className="z-30 relative lg:w-1/2">
                    <div className="hidden h-[500px] bg-primary w-full lg:w-7/12 lg:flex justify-end items-center">
                        <div className="w-full lg:w-auto lg:-mr-32">
                            <img src="https://i.ibb.co/YQjkqWr/juan-burgos-FIy-XGZ1q0mc-unsplash-1.png" alt="" className="w-full h-[500px] relative z-30 px-6 py-14" />
                        </div>
                    </div>
                    <div className="absolute top-0 md:h-96 w-full hidden md:block lg:hidden"></div>
                    <div className="w-full h-full lg:hidden">
                        <img src="https://i.ibb.co/YQjkqWr/juan-burgos-FIy-XGZ1q0mc-unsplash-1.png" alt="" className="w-full relative z-30 lg:pl-20 md:px-6 py-5 md:py-14" />
                    </div>
                </div>
