        ...
        <div className='px-12 py-12 mx-12 mt-12 shadow-md border border-gray-100'>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div class="mb-6">
                    ...
                    <input type="text" id="img" value={user?.photoURL} class="mr-72 shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 " />
                </div>
                <div class="mb-6">
                ...
                <div class="mb-6">
                    ...
                    <textarea {...register("reviews")} name="reviews" id="" cols="10" rows="4" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full"></textarea>
                </div>
                <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add Review</button>
            </form>
